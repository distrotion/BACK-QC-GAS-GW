...
router.get('/CHECK-TPGHMV002', async (req, res) => {
  ...
  return res.json(TPGHMV002db['PO']);
});
    ...
    if (input['PO'] !== undefined && input['CP'] !== undefined && input['ITEMs'] !== undefined) {
      ...
      for (i = 0; i < findcp[0]['FINAL'].length; i++) {
        if (findcp[0]['FINAL'][i]['ITEMs'] === input['ITEMs']) {
          ...
          TPGHMV002db["INTERSEC"] = masterITEMs[0]['INTERSECTION'];
          output = 'OK';
        ...
        if (masterITEMs.length > 0) {
          ...
          if (masterITEMs[0]['RESULTFORMAT'] === 'Number') {
            ...
            if (TPGHMV002db['GRAPHTYPE'] == 'CDE' ) {
              ...
              //
            } else if (TPGHMV002db['GRAPHTYPE'] == 'CDT' ) {
              ...
              //
            } else if (TPGHMV002db['GRAPHTYPE'] == 'CDT(S)' ) {
